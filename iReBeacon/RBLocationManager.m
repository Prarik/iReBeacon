...
@interface RBLocationManager () <CBPeripheralManagerDelegate>
...
static RBLocationManager *_sharedInstance = nil;
...
+ (instancetype)sharedManager {
    ...
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[RBLocationManager alloc] init];
    });
...
- (void)startAdvertisingBeacon {
    ...
    if (![self.peripheralManager isAdvertising]) {
        self.peripheralData = [[RBBeaconRegion targetRegion] peripheralDataWithMeasuredPower:nil];
...
- (void)startBeaconRanging {
    ...
    [self.locationManager startRangingBeaconsInRegion:[RBBeaconRegion targetRegion]];
...
- (void)initializeRegionMonitoring {
    ...
    if ([RBAppDelegate appDelegate].applicationMode == RBApplicationModeRegionMonitoring) {
        
        // begin region monitoring
        [self.locationManager startMonitoringForRegion:[RBBeaconRegion targetRegion]];
...
- (void)locationManager:(CLLocationManager *)manager didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region {
    ...
    if (manager == self.locationManager &&
        [region.identifier isEqualToString:kBeaconRegionIdentifier] &&
